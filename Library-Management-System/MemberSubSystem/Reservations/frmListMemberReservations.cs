...
{
    public partial class frmListMemberReservations : Form
    {
        private DataView _ReservationsDataView;

        public frmListMemberReservations()
        {
            InitializeComponent();
        }
        ...
        {
            _ReservationsDataView = clsReservation.GetMemberReservations(clsGlobal.CurrentMember.MemberID).DefaultView;
